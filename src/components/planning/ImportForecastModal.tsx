...
export function ImportForecastModal({ open, onOpenChange, onSuccess }: ImportForecastModalProps) {
  const { user } = useAuth();
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      setImportStats({ inserted: records.length, updated: 0 });
      setStep('complete');
      onSuccess();
    } catch (error: any) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Importar Previsão de Vendas</DialogTitle>
          <DialogDescription>
            Importe a planilha de previsão do comercial com os meses
          </DialogDescription>
        </DialogHeader>
        ...
        {step === 'upload' && (
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Formato esperado: Código do produto + colunas de meses (Jan/26, Fev/26...)
            </p>
        ...
        {step === 'configure' && (
          <div className="space-y-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="space-y-2">
                <Label>Versão da Previsão</Label>
                <Input
                  value={version}
                ...
                <p className="text-xs text-muted-foreground">
                  Identificador para rastrear diferentes versões da previsão
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card>
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">Registros de previsão</p>
                </CardContent>
              </Card>
            </div>
        ...
        {step === 'importing' && (
          <div className="py-8 space-y-4 text-center">
            ...
            <p className="font-medium">Importando previsão...</p>
        ...
        {step === 'complete' && (
          <div className="py-8 space-y-4 text-center">
            ...
            <p className="text-muted-foreground">
              {importStats.inserted} registros importados com sucesso
            </p>
